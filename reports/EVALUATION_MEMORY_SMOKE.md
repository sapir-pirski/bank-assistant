...
Generated at: `2026-06-30T09:23:48.282300+00:00`
...
- Raw JSON: `reports/evaluation_memory_smoke.json`

## Best Configurations

| Selection | Embedding | Similarity | Top K | LLM | Avg Score | Pass Rate | Avg Latency | Temp Fallbacks |
| --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: |
| Best overall | text-embedding-3-large | cosine | 3 | gpt-5.4 | 5 | 1 | 2679 | 0 |
| Best with temperature honored | text-embedding-3-large | cosine | 3 | gpt-5.4 | 5 | 1 | 2679 | 0 |

## Ranked Results

| Rank | Stage | Embedding | Similarity | Top K | LLM | Grounded | Relevant | Safe | Avg | Pass | Latency | Temp Fallbacks | Errors |
| ---: | --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | full | text-embedding-3-large | cosine | 3 | gpt-5.4 | 5 | 5 | 5 | 5 | 1 | 2679 | 0 | 0 |
